...
reqstr+='>';return reqstr;};JSJaCWebSocketConnection.prototype.send=function(packet,cb,arg){if(!this.connected()){return false;}
if(!packet||!packet.pType){this.oDbg.log('no packet: '+packet,1);return false;}
this._ws.onmessage=JSJaC.bind(this._onmessage,this);if(cb){if(!packet.getID()){packet.setID('JSJaCID_'+this._ID++);}
